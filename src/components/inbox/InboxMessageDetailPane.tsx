...
export default function InboxMessageDetailPane({
 ...
 <div
 className={`w-10 h-10 rounded flex items-center justify-center shrink-0 ${getCategoryColor(selectedMessage.category)} bg-primary-500/10 dark:bg-primary-500/20`}
 >
