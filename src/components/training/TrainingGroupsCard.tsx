...
export default function TrainingGroupsCard({
 ...
 disabled={isSaving}
 className="text-danger-400 hover:text-danger-500 transition-colors disabled:opacity-50"
 ...
 <td
 className={`py-1.5 px-3 text-xs font-mono font-mono font-bold tabular-nums ${condColor(player.condition)}`}
 >
