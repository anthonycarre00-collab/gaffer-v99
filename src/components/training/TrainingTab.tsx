...
const TRAINING_FOCUS_ATTRS: Record<string, string[]> = {
 Physical: ["pace", "engine", "power", "agility"],
 Technical: ["passing", "finishing", "touch"],
 Tactical: ["anticipation", "vision", "decisions", "composure"],
 Defending: ["defending", "defending", "power", "anticipation"],
 Attacking: ["finishing", "touch", "pace"],
 Recovery: [],
};
...
export default function TrainingTab({
 ...
 return (
 <div className="pitch-grass-bg grid grid-cols-1 lg:grid-cols-3 gap-5">
