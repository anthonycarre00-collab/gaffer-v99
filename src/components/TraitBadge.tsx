...
const TRAIT_META: Record<string, TraitMeta> = {
  ...
  Tank: {
    ...
    requirements: [
      ...
      { labelKey: "common.attributes.engine", value: 75, operator: ">=" },
    ],
  },
  Agile: {
  ...
  BallWinner: {
    ...
    requirements: [
      ...
      { labelKey: "common.50", value: 70, operator: ">=" },
    ],
  },
  Rock: {
    ...
    requirements: [
      ...
      { labelKey: "common.attributes.anticipation", value: 75, operator: ">=" },
    ],
  },
  Leader: {
    ...
    requirements: [
      ...
      { labelKey: "common.50", value: 75, operator: ">=" },
    ],
  },
  CoolHead: {
  ...
  SafeHands: {
    ...
    category: "goalkeeper",
    requirements: [{ labelKey: "common.attributes.shot_stopping", value: 85, operator: ">=" }],
  },
  CatReflexes: {
  ...
  CompleteForward: {
    ...
    category: "special",
    requirements: [
      { labelKey: "common.attributes.finishing", value: 75, operator: ">=" },
      { labelKey: "common.attributes.touch", value: 75, operator: ">=" },
      { labelKey: "common.attributes.pace", value: 70, operator: ">=" },
      { labelKey: "common.attributes.power", value: 70, operator: ">=" },
    ],
  },
  Engine: {
    ...
    category: "special",
    requirements: [
      { labelKey: "common.attributes.engine", value: 85, operator: ">=" },
      { labelKey: "common.attributes.pace", value: 70, operator: ">=" },
      { labelKey: "common.50", value: 75, operator: ">=" },
    ],
  },
