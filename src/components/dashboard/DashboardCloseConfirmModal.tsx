...
export default function DashboardCloseConfirmModal({
 ...
 className="w-full rounded bg-primary-500 px-4 py-2.5 text-sm font-heading font-bold uppercase tracking-wider text-ink transition-colors hover:bg-primary-600"
 >
 {t("closeConfirm.saveQuit")}
 </button>
 <button
 onClick={onQuitWithoutSave}
 className="w-full rounded bg-danger-500 px-4 py-2.5 text-sm font-heading font-bold uppercase tracking-wider text-ink transition-colors hover:bg-danger-600"
 >
