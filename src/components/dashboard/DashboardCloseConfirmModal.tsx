...
export default function DashboardCloseConfirmModal({
 ...
 className="w-full rounded bg-red-500 px-4 py-2.5 text-sm font-heading font-bold uppercase tracking-wider text-white transition-colors hover:bg-red-600"
 >
 {t("closeConfirm.quitNoSave")}
 </button>
 <button
 onClick={onCancel}
 className="w-full rounded bg-gray-100 px-4 py-2.5 text-sm font-heading font-bold uppercase tracking-wider text-gray-700 transition-colors hover:bg-gray-200 dark:bg-navy-700 dark:text-gray-300 dark:hover:bg-navy-600"
 >
 {t("common.cancel")}
 </button>
 </div>
