...
export default function FiredModal(): JSX.Element | null {
 ...
 <div className="mx-4 w-full max-w-lg rounded bg-white shadow-2xl dark:bg-navy-800 dark:border dark:border-navy-700">
 {/* Header */}
 ...
 className="w-full rounded bg-gray-700 dark:bg-navy-700 px-6 py-3 font-heading font-bold text-sm uppercase tracking-wider text-white transition-all hover:bg-gray-800 dark:hover:bg-navy-600 "
 >
