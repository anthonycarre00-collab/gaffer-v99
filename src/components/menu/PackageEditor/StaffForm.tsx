...
export function StaffForm({
 ...
 min={1}
 max={99}
 className="w-full rounded border border-slate-line bg-white bg-carbon-2 px-3 py-2 text-sm text-ink focus:outline-none focus:ring-2 focus:ring-primary-400 transition"
 value={attrs[key]}
