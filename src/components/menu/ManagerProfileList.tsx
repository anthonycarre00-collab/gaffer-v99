...
export default function ManagerProfileList({ profiles, selectedProfileId, onSelect, onDelete }: ManagerProfileListProps) {
 ...
 <div className={`absolute inset-0 flex items-center justify-end gap-1.5 px-3 rounded ${isSelected ? "bg-primary-50 dark:bg-primary-500/10" : "bg-white dark:bg-navy-700"}`}>
 <button
 type="button"
