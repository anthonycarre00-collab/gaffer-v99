...
describe("ScoutingTab.model", () => {
  it("filters scoutable players by team, position, and search query (sorted alphabetically — sorting by OVR would leak relative ability of unscouted players)", () => {
    const teams = [
      createTeam(),
    ...
    const players = [
      ...
      createPlayer({ id: "defender", team_id: "team-2", full_name: "Alan Back", natural_position: "Defender", position: "Defender", ovr: 66, attributes: { pace: 50, burst: 50, engine: 60, power: 65, agility: 55, passing: 58, distribution: 50, touch: 40, finishing: 30, defending: 74, aerial: 66, anticipation: 70, vision: 50, decisions: 63, composure: 60, leadership: 55, shot_stopping: 20, commanding: 20, playing_out: 30 } }),
      createPlayer({ id: "forward", team_id: "team-3", full_name: "Carlos Goal", nationality: "BR", natural_position: "Forward", position: "Forward", ovr: 74, attributes: { pace: 78, burst: 75, engine: 70, power: 65, agility: 75, passing: 63, distribution: 60, touch: 79, finishing: 80, defending: 28, aerial: 62, anticipation: 76, vision: 64, decisions: 68, composure: 72, leadership: 49, shot_stopping: 20, commanding: 20, playing_out: 30 } }),
