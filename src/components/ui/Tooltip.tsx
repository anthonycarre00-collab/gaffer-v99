...
export function Tooltip({
 ...
 {visible && (
 <span
 className={`absolute z-50 ${positionClasses[position]} pointer-events-none whitespace-normal max-w-[250px] rounded-lg bg-gray-900 dark:bg-navy-900 px-3 py-2 text-xs text-white shadow-lg animate-in fade-in duration-150`}
 role="tooltip"
 >
 {text}
 </span>
