...
export default function ScoutPlayerCard({ report, onPlayerClick }: ScoutPlayerCardProps) {
 ...
 { labelKey: "common.attributes.finishing", value: report.finishing },
 { labelKey: "common.attributes.passing", value: report.passing },
 { labelKey: "common.attributes.touch", value: report.touch },
 { labelKey: "common.attributes.defending", value: report.defending },
 { labelKey: "common.attributes.power", value: report.physical },
 ];
 ...
 className={`mt-4 rounded border border-gray-200 dark:border-navy-600 from-gray-50 to-white dark: dark: overflow-hidden ${onPlayerClick ? "cursor-pointer hover:border-primary-400 dark:hover:border-primary-500 hover: transition-all" : ""
 }`}
 >
 {/* Header */}
