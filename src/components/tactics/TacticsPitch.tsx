...
function getPitchMarkerClassName(options: {
 ...
 const base =
 "absolute z-20 flex w-[6rem] -translate-x-1/2 -translate-y-1/2 cursor-grab flex-col items-center gap-0.5 rounded px-1 py-1 text-center transition-all active:cursor-grabbing";
 ...
 if (isSelected) {
 return `${base} bg-accent-500/15 ring-2 ring-accent-300/60 `;
 }

 if (isComparing) {
 return `${base} bg-primary-500/10 ring-2 ring-primary-300/50 `;
 }

 if (isHovered) {
 return `${base} bg-primary-500/10 `;
 }
