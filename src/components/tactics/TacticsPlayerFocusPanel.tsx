...
const ATTRIBUTE_GROUPS: {
 ...
 attrs: ["pace", "engine", "power", "agility"],
 },
 {
 labelKey: "common.attrGroups.technical",
 attrs: ["passing", "finishing", "defending", "touch", "defending"],
 },
 {
 ...
 attrs: ["shot_stopping", "shot_stopping", "aerial"],
 },
 ];
...
function SinglePlayerAttributes({ player }: { player: PlayerData }) {
 ...
 <span
 className={`text-sm font-mono font-mono font-bold tabular-nums ${valueTone(value)}`}
 >
 {value}
 </span>
 </div>
