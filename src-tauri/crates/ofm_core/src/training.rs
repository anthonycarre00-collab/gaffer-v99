...
fn apply_focus_gains(
    ...
    match focus {
        TrainingFocus::Physical => {
            ...
            try_gain(&mut attrs.engine, gain, rng);
            try_gain(&mut attrs.power, gain, rng);
            try_gain(&mut attrs.agility, gain, rng);
        }
        TrainingFocus::Technical => {
            try_gain(&mut attrs.passing, gain, rng);
            try_gain(&mut attrs.finishing, gain, rng);
            try_gain(&mut attrs.touch, gain, rng);
        }
        TrainingFocus::Tactical => {
            try_gain(&mut attrs.anticipation, gain, rng);
        ...
        TrainingFocus::Defending => {
            ...
            try_gain(&mut attrs.defending, gain, rng);
            try_gain(&mut attrs.power, gain * 0.5, rng);
            try_gain(&mut attrs.anticipation, gain * 0.5, rng);
        }
