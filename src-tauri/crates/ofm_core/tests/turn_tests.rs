...
fn set_player_overall(player: &mut Player, overall: u8) {
    ...
    player.attributes.engine = overall;
    player.attributes.power = overall;
    player.attributes.passing = overall;
    player.attributes.finishing = overall;
    player.attributes.defending = overall;
    player.attributes.touch = overall;
    player.attributes.defending = overall;
    player.attributes.anticipation = overall;
